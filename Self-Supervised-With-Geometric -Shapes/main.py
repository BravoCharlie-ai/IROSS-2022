...
from train_dataset_random_object_selection import TrainDataset
...
def main():
	...
	#save_folder='weights/exp_1/'
	#log_address='weights/exp_1/log'
	...
	train_dataset=TrainDataset(total_length=40000,points_per_object=512)
	...
	for i, (input, det_info, det_id, det_cls,det_split) in enumerate(train_dataset):
		current_step=last_iter + i+1

		#print(det_info['boxes'][0].shape)
		#print(det_info['boxes'][1].shape)
		...
		if current_step%(int(train_data_length))==0:
