...
parser.add_argument('--result-path', default="weights/exp_1/test_epoch_3", type=str)
...
def main():
	root_dir='/home/c3-0/datasets/JRDB-new-version/processed_data/test_sequences/'
	#root_dir='/home/c3-0/datasets/JRDB/MOT_output_pt/sequences/'
	print('start_creating_dataset')
	val_dataset=TestSequenceDataset(root_dir,points_per_object=512)
	...
	load_model_dir='weights/exp_1/ss_JRDB_epoch_3.0_Loss_ 0.0905.pth'
