...
class TestSequenceDataset(object):
    def __init__(self, root_dir, points_per_object,fix_iou=0.2, fix_count=2, gt_ratio=0, sample_max_len=2):
    ...
    def _generate_meta_seq(self):
        ...
        for seq_id in self.val_seqs:
            ...
            fname='/home/c3-0/datasets/JRDB-new-version/test_dataset_without_labels/detections/detections_3d/'+seq_id+'.json'
